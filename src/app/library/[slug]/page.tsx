              ...
              <div className="flex gap-4">
                {indicator.tradingViewLink && (
                  <a
                    ...
                    className="text-white px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center bg-gradient-to-r from-[#DD0000] to-[#FF5B41] hover:from-[#FF5B41] hover:to-[#DD0000]"
                  >
